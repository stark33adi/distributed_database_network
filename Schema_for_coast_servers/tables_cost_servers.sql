--      THE TABLE SCHEMA FOR EACH  COAST SERVER
CREATE TABLE City(
...
alter table membership add column dvdattime numeric;
...
CREATE TABLE REDBOX(
RedBoxId           numeric(16) NOT NULL,
AddressId     numeric(10) NOT NULL,
CONSTRAINT REDBOX_RedBoxId_PK PRIMARY KEY (RedBoxId),
CONSTRAINT REDBOX_AddressId  FOREIGN KEY (AddressId) REFERENCES ZipCode(ZipCodeId));

CREATE TABLE DVDQUANTITY(
DVDId           numeric(16) NOT NULL,
RedBoxId           numeric(16) NOT NULL,
DVDQuantityOnHand   numeric(8)  NOT NULL,
DVDQuantityOnRent   numeric(8)  NOT NULL,
DVDLostQuantity     numeric(8)  NOT NULL,
CONSTRAINT DVDQUANTITY_DVDId_FK FOREIGN KEY (DVDId) REFERENCES DVD(DVDId),
CONSTRAINT DVDQUANTITY_RedBoxId  FOREIGN KEY (RedBoxId) REFERENCES REDBOX(RedBoxId));
